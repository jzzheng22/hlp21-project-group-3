...
let init () =
    ...
    [
        ...
        (CreateNewSymbol (CommonTypes.ComponentType.Output 2) 1 0 {X = 200.; Y = 400.})
    ]
    , Cmd.none
...
let getSymbolIdFromPortId (model: Model) (pId: CommonTypes.PortId) : CommonTypes.ComponentId =

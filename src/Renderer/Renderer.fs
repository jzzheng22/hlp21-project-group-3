        ...
        jsOptions<MenuItemOptions> <| fun invisibleMenu ->
            ...
            invisibleMenu.submenu <-
                [| makeKeyItem "Default" "CmdOrCtrl+S" (fun () -> dispatch KeyboardMsg.CtrlS)
                   ...
                   menuSeparator
                   makeKeyItem "Zoom Diagram In" "CmdOrCtrl+M" (fun () -> dispatch KeyboardMsg.ZoomCanvasIn)
                   makeKeyItem "Zoom Diagram Out" "CmdOrCtrl+D" (fun () -> dispatch KeyboardMsg.ZoomCanvasOut)
                   menuSeparator
